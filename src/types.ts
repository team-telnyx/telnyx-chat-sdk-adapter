...
export interface TelnyxAdapterConfig {
  ...
  userName?: string;
  /** User-supplied tags to attach to every outbound message, in addition to the adapter attribution tags. */
  extraTags?: string[];
  /** Opt out of attribution tags (the adapter will still send userTags if provided). Default: false. */
